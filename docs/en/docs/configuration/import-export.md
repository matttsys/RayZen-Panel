...
Importing or exporting panel settings via Files or RayZen Panel peers.
...
You can easily share your panel settings with a RayZen peer or import others' settings.
