...
برای اشتراک‌های بدون **Fragment** شاید بخواید از Clean IP استفاده کنید. RayZen خودش اسکنر داره: تب **Intelligence** رو باز کنید، **Discover candidates** رو بزنید و بعد اسکن کنید. خودش کاندیدها رو پیشنهاد می‌ده، امتیازدهی می‌کنه و می‌گه کدوم رو استفاده کنید؛ پس چیزی برای دانلود و اجرا روی سیستم خودتون نیست.

اسکنر از همون نقطه‌ی لبه‌ی Cloudflare که به درخواست شما پاسخ داده اندازه‌گیری می‌کنه، یعنی یک نقطه‌ی دید. ممکنه اندپوینتی از آن نقطه تمیز باشه و از دید ISP شما نه، پس امتیازها رو فهرست اولیه در نظر بگیرید نه حکم قطعی، و کانفیگ **Best Ping** رو در اشتراکتون نگه دارید: بهترین اندپوینت رو در زمان اتصال انتخاب می‌کنه.
...
### NAT64 Prefixes
 ...
 می‌تونید حالت و Prefixها رو از پنل تغییر بدید و بعد اشتراک رو به‌روزرسانی کنید. ولی تنظیم‌کردنشون به‌عنوان متغیرهای محیطی `RAYZEN_PROXY_IP_MODE` و `RAYZEN_PREFIXES` در داشبورد Cloudflare ترجیح داره، چون:
...
Prefixهای NAT64 مخصوص منطقه و ISP هستن؛ از پیشوندی استفاده کنید که با شبکه‌ی شما سازگاره (جستجوی پیشوند NAT64 فعلی برای کشور و اپراتور خودتان لیست‌های به‌روزی میده).
